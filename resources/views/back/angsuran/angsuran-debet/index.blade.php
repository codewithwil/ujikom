               ...
               <div class="table-responsive">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>Ro{{ number_format($item->nominal / $item->periode, 2) }}</td>
                    <td>{{$item->status_buku}}</td>
                    <td>
                      <a href="{{route('angsuran.debet.detail', $item->kode_pinjaman_debet)}}" class="btn btn-primary shadow btn-xs sharp me-1 btn-edit"><i class="fa fa-eye"></i></a>
                    </td>
                  </tr>
                  @endforeach
                  </tbody>
