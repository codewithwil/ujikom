               ...
               <div class="table-responsive">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{route('saldo.edit', $item->kode_simpanan_kredit)}}" class="btn btn-primary shadow btn-xs sharp me-1 btn-edit"><i class="fas fa-pencil-alt"></i></a>

                        <a href="#" onclick="deleteSaldo(this)" data-id="{{$item->kode_simpanan_kredit}}" 
