...
<section class="content">
  ...
  Laporan Bagi hasil Koperasi{{optional(optional($pengaturan)->first())->nama_perusahaan}}
  </div>
...
@endforeach
  ...
  <div class="col-12">
  <a href="{{ route('print.bagiHasil') }}" rel="noopener" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a>
