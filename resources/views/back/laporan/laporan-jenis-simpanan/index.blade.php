...
@section('title', 'laporan jenis Simpanan')
@section('content')
...
<section class="content">
  ...
  Laporan jenis simpanan  Koperasi{{optional(optional($pengaturan)->first())->nama_perusahaan}}
  </div>
...
@endforeach
  ...
  <div class="col-12">
  <a href="{{ route('print.jenisSimpanan') }}" rel="noopener" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a>
